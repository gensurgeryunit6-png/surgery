...
(function(){
  ...
  const obs=new MutationObserver(()=>{reorder();blockLegacyWaitingEnhancer()});obs.observe(document.documentElement,{childList:true,subtree:true});setTimeout(reorder,100);setTimeout(reorder,500);setTimeout(reorder,1500);
})();
